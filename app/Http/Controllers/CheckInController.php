...
class CheckInController extends Controller
{
    ...
    {
        if (empty($preUserId) || ! PreRegistration::whereId($preUserId)->exists()) {
    ...
    public function store(Request $request, Company $company)
    {
        ...
        $visit = Visit::create([
            ...
            'arrival' => Carbon::createFromFormat('H:i:s', $data['arrival'])->toDateTimeString(),
            'departure' => Carbon::createFromFormat('H:i:s', $data['departure'])->toDateTimeString(),
