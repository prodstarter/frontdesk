    ...
    <body>
        <div class="container">
            <main>
                ...
                <p>Hello Admin,</p>
                <p>
                    A new guest has preregister for <strong>{{ $company->name }}</strong>. You can check them in via the
                    link below.
                </p>
                <div class="details">
                    <p>
                ...
                <a href="{{ route('check-in.create', ['company' => $company->uuid, 'preregistration' => $userData->id]) }}"
                    class="marketing-login-link">
                    Check In To {{ $company->name }} Here
                </a>
