            ...
            <form wire:submit.prevent="store">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input wire:model="first_name" name="first_name" type="text" placeholder="Enter first name"
                    ...
                    <div>
                        <label class="block text-gray-700 mb-1">Last Name <span
                                class="text-lg text-red-500">*</span></label>
                        <input wire:model="last_name" name="last_name" type="text" placeholder="Enter last name"
                            class="w-full px-3 py-2 border rounded-md focus:outline-blue-500"
                ...
                <div class="mt-6 text-center">
                    <button type="submit" class="bg-blue-500 text-white px-6 py-2 rounded-md w-2/3 hover:bg-blue-600">
                        ➡️ Register
                    </button>
                </div>
            </form>
